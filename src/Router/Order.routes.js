...
router.put('/update-order-status', verifyToken, orders.updateOrderStatus );
router.put('/update-status-order-dispatched', verifyToken, orders.updateOrderStatusToDispatched );
router.get('/get-all-orders-by-delivery/:deliveryId/:statusOrder', verifyToken, orders.getOrdersByDelivery );
